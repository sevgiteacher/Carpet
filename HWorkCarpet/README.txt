...
2. Write a class with the name carpets.Carpet. The class needs one field (instance variable) with name cost of type double.
...
3. Write a class with the name Calculator. The class needs two fields (instance variables) with name floor of type Floor and carpet of type carpets.Carpet.

The class needs to have one constructor with parameters floor of type Floor and carpet of type carpets.Carpet and it needs to initialize the fields.
...
carpets.Carpet carpet = new carpets.Carpet(3.5);
Floor floor = new Floor(2.75, 4.0);
Calculator calculator = new Calculator(floor, carpet);
System.out.println("total= " + calculator.getTotalCost());
carpet = new carpets.Carpet(1.5);
